(function(){
  ...
  EnemyLarge = RailShooter.EnemyLarge = function(options){
    ...
    this.addEventListener("tick", function(){
      ...
      if(enemy.gunTimer <= 0 && enemy.game.ship && !enemy.dead){
        enemy.fireMainGun();
        enemy.gunTimer = (enemy.size == "large" ? 20 : 30);
      };

      if(enemy.hitPoints < enemy.maxHitPoints / 2 && enemy.size == "normal"){
