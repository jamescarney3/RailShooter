(function(){
  ...
  EnemyLarge.prototype.takeAim = function(ship){
    ...
    if(this.hitPoints <= 10){
      return [
        RailShooter.Util.angleVector(Math.PI * 1/8, 5),
        RailShooter.Util.angleVector(Math.PI * 2/8, 5),
        RailShooter.Util.angleVector(Math.PI * 3/8, 5),
        RailShooter.Util.angleVector(Math.PI * 4/8, 5),
        RailShooter.Util.angleVector(Math.PI * 5/8, 5),
        RailShooter.Util.angleVector(Math.PI * 6/8, 5),
        RailShooter.Util.angleVector(Math.PI * 7/8, 5)
        ]
    }else if(this.hitPoints <= this.maxHitPoints / 1.33){
      return [
        RailShooter.Util.angleVector(angle, 5),
        RailShooter.Util.angleVector(angle * (1 + spread), 5),
        RailShooter.Util.angleVector(angle * (1 - spread), 5)
        ];
    }else{
